...
{
    public function test_metadata_context_is_null_upon_creation(): void
    {
    ...
    public function test_returns_set_metadata_context(): void
    {
    ...
    public function test_returns_all_contexts(): void
    {
    ...
    public function test_throws_invalid_argument_exception_if_constructed_with_non_credential_context_array(): void
    {
