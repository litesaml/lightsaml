...
class SamlPostResponseTest extends BaseTestCase
{
    ...
    public function test_get_status_code_delegates_to_inner()
    {
    ...
    public function test_get_reason_phrase_delegates_to_inner()
    {
    ...
    public function test_get_protocol_version_delegates_to_inner()
    {
        $inner = $this->factory->createResponse(200);
        $response = new SamlPostResponse($inner, 'https://sp.example.com/acs', []);
    ...
    public function test_with_status_returns_new_instance_and_preserves_metadata()
    {
    ...
    public function test_with_header_returns_new_instance_and_preserves_metadata()
    {
        $response = $this->makeResponse('https://sp.example.com/acs', ['SAMLResponse' => 'abc']);
    ...
    public function test_with_added_header_returns_new_instance()
    {
    ...
    public function test_without_header_returns_new_instance()
    {
    ...
    public function test_with_body_returns_new_instance()
    {
    ...
    public function test_with_protocol_version_returns_new_instance()
    {
        $response = $this->makeResponse();
    ...
    public function test_get_headers_delegates_to_inner()
    {
    ...
    public function test_build_html_contains_destination_and_fields()
    {
    ...
    public function test_build_html_handles_null_destination()
    {
        $html = SamlPostResponse::buildHtml(null, []);
        $this->assertStringContainsString('action=""', $html);
    }

    public function test_with_status_chained_multiple_times_preserves_immutability()
    {
