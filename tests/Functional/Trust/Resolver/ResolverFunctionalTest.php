...
namespace Tests\Functional\Trust\Resolver;
...
{
    public function test__idp2(): void
    {
    ...
    public function test__idp(): void
    {
        $resolver = $this->getResolver();
    ...
    public function test__sp2(): void
    {
        $resolver = $this->getResolver();
    ...
    public function test__get_private_key(): void
    {
        $resolver = $this->getResolver();
